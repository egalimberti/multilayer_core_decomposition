...
def densest_subgraph(multilayer_graph, beta):
    ...
    maximum_density, maximum_layers, maximum_average_degrees = objective_function(multilayer_graph.number_of_nodes, multilayer_graph.get_number_of_edges_layer_by_layer(), beta)
